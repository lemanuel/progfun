...
abstract class TweetSet {
   ...
   * and be implemented in the subclasses?
    *
    * Answer: The method should be implemented here. It should use the `filterAcc` method
    * which should be overwriten by the subclasses, Empty and NonEmpty.
   */
...
object GoogleVsApple {
  ...
  lazy val googleTweets: TweetSet = TweetReader.allTweets filter (
    tweet => google exists (
      token => tweet.text contains token))
